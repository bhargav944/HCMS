...
public class AddPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected(AddPostActivity.this)) buildDialog(AddPostActivity.this).show();
        else {
            Toast.makeText(AddPostActivity.this,R.string.add_post, Toast.LENGTH_SHORT).show();
            setContentView(R.layout.activity_add_post);
        }
