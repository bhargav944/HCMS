...
public class VitaminA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected(VitaminA.this)) buildDialog(VitaminA.this).show();
        else {
            Toast.makeText(VitaminA.this,R.string.vitamina, Toast.LENGTH_SHORT).show();
            setContentView(R.layout.activity_vitamin_a);
        }
        ...
        mRef = mFirebaseDatabase.getReference("Vitamins").child("Vitamin A");
    }
    ...
    private void checkUserStatus() {
        ...
        if (user != null) {
            ...
            startActivity(new Intent(VitaminA.this, LoginActivity.class));
            finish();
        }
    }
