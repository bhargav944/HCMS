...
public class VitaminB1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected(VitaminB1.this)) buildDialog(VitaminB1.this).show();
        else {
            Toast.makeText(VitaminB1.this,R.string.vitaminb1, Toast.LENGTH_SHORT).show();
            setContentView(R.layout.activity_vitamin_b1);
        }
        ...
        mRef = mFirebaseDatabase.getReference("Vitamins").child("Vitamin B1");
    }
    ...
    private void checkUserStatus() {
        ...
        if (user != null) {
            ...
            startActivity(new Intent(VitaminB1.this, LoginActivity.class));
            finish();
        }
    }
