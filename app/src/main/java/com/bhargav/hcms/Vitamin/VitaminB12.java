...
public class VitaminB12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected(VitaminB12.this)) buildDialog(VitaminB12.this).show();
        else {
            Toast.makeText(VitaminB12.this,R.string.vitaminb12, Toast.LENGTH_SHORT).show();
            setContentView(R.layout.activity_vitamin_b12);
        }
        ...
        mRef = mFirebaseDatabase.getReference("Vitamins").child("Vitamin B12");
    }
    ...
    private void checkUserStatus() {
        ...
        if (user != null) {
            ...
            startActivity(new Intent(VitaminB12.this, LoginActivity.class));
            finish();
        }
    }
