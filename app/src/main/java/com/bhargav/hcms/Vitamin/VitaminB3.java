...
public class VitaminB3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected(VitaminB3.this)) buildDialog(VitaminB3.this).show();
        else {
            Toast.makeText(VitaminB3.this,R.string.vitaminb3, Toast.LENGTH_SHORT).show();
            setContentView(R.layout.activity_vitamin_b3);
        }
        ...
        mRef = mFirebaseDatabase.getReference("Vitamins").child("Vitamin B3");
    }
    ...
    private void checkUserStatus() {
        ...
        if (user != null) {
            ...
            startActivity(new Intent(VitaminB3.this, LoginActivity.class));
            finish();
        }
    }
