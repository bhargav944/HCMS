...
public class VitaminB5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected(VitaminB5.this)) buildDialog(VitaminB5.this).show();
        else {
            Toast.makeText(VitaminB5.this,R.string.vitaminb5, Toast.LENGTH_SHORT).show();
            setContentView(R.layout.activity_vitamin_b5);
        }
        ...
        mRef = mFirebaseDatabase.getReference("Vitamins").child("Vitamin B5");
    }
    ...
    private void checkUserStatus() {
        ...
        if (user != null) {
            ...
            startActivity(new Intent(VitaminB5.this, LoginActivity.class));
            finish();
        }
    }
