...
public class VitaminB6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected(VitaminB6.this)) buildDialog(VitaminB6.this).show();
        else {
            Toast.makeText(VitaminB6.this,R.string.vitaminb6, Toast.LENGTH_SHORT).show();
            setContentView(R.layout.activity_vitamin_b6);
        }
        ...
        mRef = mFirebaseDatabase.getReference("Vitamins").child("Vitamin B6");
    }
    ...
    private void checkUserStatus() {
        ...
        if (user != null) {
            ...
            startActivity(new Intent(VitaminB6.this, LoginActivity.class));
            finish();
        }
    }
