...
public class VitaminB7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected(VitaminB7.this)) buildDialog(VitaminB7.this).show();
        else {
            Toast.makeText(VitaminB7.this,R.string.vitaminb7, Toast.LENGTH_SHORT).show();
            setContentView(R.layout.activity_vitamin_b7);
        }
        ...
        mRef = mFirebaseDatabase.getReference("Vitamins").child("Vitamin B7");
    }
    ...
    private void checkUserStatus() {
        ...
        if (user != null) {
            ...
            startActivity(new Intent(VitaminB7.this, LoginActivity.class));
            finish();
        }
    }
