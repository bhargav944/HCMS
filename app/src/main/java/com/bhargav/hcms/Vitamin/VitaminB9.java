...
public class VitaminB9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected(VitaminB9.this)) buildDialog(VitaminB9.this).show();
        else {
            Toast.makeText(VitaminB9.this,R.string.vitaminb9, Toast.LENGTH_SHORT).show();
            setContentView(R.layout.activity_vitamin_b9);
        }
        ...
        mRef = mFirebaseDatabase.getReference("Vitamins").child("Vitamin B9");
    }
    ...
    private void checkUserStatus() {
        ...
        if (user != null) {
            ...
            startActivity(new Intent(VitaminB9.this, LoginActivity.class));
            finish();
        }
    }
