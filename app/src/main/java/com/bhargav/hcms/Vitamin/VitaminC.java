...
public class VitaminC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected(VitaminC.this)) buildDialog(VitaminC.this).show();
        else {
            Toast.makeText(VitaminC.this,R.string.vitaminc, Toast.LENGTH_SHORT).show();
            setContentView(R.layout.activity_vitamin_c);
        }
        ...
        mRef = mFirebaseDatabase.getReference("Vitamins").child("Vitamin C");
    }
    ...
    private void checkUserStatus() {
        ...
        if (user != null) {
            ...
            startActivity(new Intent(VitaminC.this, LoginActivity.class));
            finish();
        }
    }
