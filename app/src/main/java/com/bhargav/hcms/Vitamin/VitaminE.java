...
public class VitaminE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected(VitaminE.this)) buildDialog(VitaminE.this).show();
        else {
            Toast.makeText(VitaminE.this,R.string.vitamine, Toast.LENGTH_SHORT).show();
            setContentView(R.layout.activity_vitamin_e);
        }
        ...
        mRef = mFirebaseDatabase.getReference("Vitamins").child("Vitamin E");
    }
    ...
    private void checkUserStatus() {
        ...
        if (user != null) {
            ...
            startActivity(new Intent(VitaminE.this, LoginActivity.class));
            finish();
        }
    }
