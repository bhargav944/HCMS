...
public class VitaminK extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected(VitaminK.this)) buildDialog(VitaminK.this).show();
        else {
            Toast.makeText(VitaminK.this,R.string.vitamink, Toast.LENGTH_SHORT).show();
            setContentView(R.layout.activity_vitamin_k);
        }
        ...
        mRef = mFirebaseDatabase.getReference("Vitamins").child("Vitamin K");
    }
    ...
    private void checkUserStatus() {
        ...
        if (user != null) {
            ...
            startActivity(new Intent(VitaminK.this, LoginActivity.class));
            finish();
        }
    }
